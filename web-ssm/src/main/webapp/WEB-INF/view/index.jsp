...
<link rel="stylesheet" href="${contextPath}/resources/js/vendors/owl-carousel/assets/owl.carousel.css">
<link rel="stylesheet" href="${contextPath}/resources/js/vendors/magnific-popup/magnific-popup.css">
...
<link href="${contextPath}/resources/css/theme/green.css" rel="stylesheet">
            ...
            <div class="col-sm-4 search-form-col">
                <form action="#" method="get" class="search-form">
                    <div class="input-group">
                        <span class="input-group-addon"><img src="${contextPath}/resources/img/search-icon-white.png" alt=""></span>
                        <input type="search" class="form-control" placeholder="search">
                    </div>
                </form>
            </div>
            <div class="col-sm-4 logo-col text-center">
                <a href="index.jsp"><img src="${contextPath}/resources/img/logo-white-green.png" alt=""></a>
            </div>
            <div class="col-sm-4 menu-trigger-col">
                <button class="menu-trigger pull-right">
                    <span class="active-page">home</span>
                    <img src="${contextPath}/resources/img/menu-align-white.png" alt="" class="icon-burger">
                    <img src="${contextPath}/resources/img/menu-close-white.png" alt="" class="icon-cross">
                </button>
            </div>
        </div>        
    </div>
                        ...
                        <ul class="nav column-menu black-bg">
                            <li class="active dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="index.jsp">Home Option 1</a></li>
...
<section class="row featured-post-carousel">
    <div class="item post">
        <img src="${contextPath}/resources/img/featured-posts/1.jpg" alt="" class="img-responsive main-bg">
    ...
    <div class="item post">
        <img src="${contextPath}/resources/img/featured-posts/1-1.jpg" alt="" class="img-responsive main-bg">
        <div class="post-content">
            <div class="container">
                <h5 class="post-meta"><i>in</i> <a href="#">Author Profile</a> | <a href="#">feb 17, 2016</a></h5>
                <h2 class="post-title"><a href="single.html">Nature, in the broadest sense, is the natural, physical, or material world or universe.</a></h2>
    ...
    <div class="item post">
        <img src="${contextPath}/resources/img/featured-posts/1-2.jpg" alt="" class="img-responsive main-bg">
        <div class="post-content">
            <div class="container">
                <h5 class="post-meta"><i>in</i> <a href="#">Author Profile</a> | <a href="#">feb 17, 2016</a></h5>
                <h2 class="post-title"><a href="single.html">Nature, in the broadest sense, is the natural, physical, or material world or universe.</a></h2>
    ...
    <div class="container">
        <div class="row" id="post-masonry">
            ...
            <article class="col-sm-4 post post-masonry post-format-image">
                <div class="post-wrapper row">
                    <div class="featured-content row">
                        <a href="single.html"><img src="${contextPath}/resources/img/posts/masonry/1.jpg" alt="" class="img-responsive"></a>
                    </div>
                    <div class="post-excerpt row">
                        ...
                        <footer class="row">
                            ...
                            <div class="response-count"><img src="${contextPath}/resources/img/comment-icon-gray.png" alt="">5</div>
                        </footer>
                    </div>
                </div>
            </article>
            ...
            <article class="col-sm-4 post post-masonry post-format-image">
                <div class="post-wrapper row">
                    <div class="featured-content row">
                        <a href="single.html"><img src="${contextPath}/resources/img/posts/masonry/2.jpg" alt="" class="img-responsive"></a>
                    </div>
                    <div class="post-excerpt row">
                        <h5 class="post-meta">
                            <a href="#" class="date">feb 17, 2016</a>
            ...
            <aside class="col-sm-4 widget-author widget widget-with-posts post">
                <div class="widget-author-inner row">
                    <div class="author-avatar row"><a href="#"><img src="${contextPath}/resources/img/author.png" alt="" class="img-circle"></a></div>
                ...
                <div class="post-wrapper row">
                    <div class="featured-content row">
                        <div class="gallery-of-post">
                            <div class="item"><img src="${contextPath}/resources/img/posts/masonry/3.jpg" alt=""></div>
                            <div class="item"><img src="${contextPath}/resources/img/posts/masonry/3.jpg" alt=""></div>
                            <div class="item"><img src="${contextPath}/resources/img/posts/masonry/3.jpg" alt=""></div>
                            <div class="item"><img src="${contextPath}/resources/img/posts/masonry/3.jpg" alt=""></div>
                            <div class="item"><img src="${contextPath}/resources/img/posts/masonry/3.jpg" alt=""></div>
            ...
            <article class="col-sm-4 post post-masonry post-format-video">
                <div class="post-wrapper row">
                    <div class="featured-content row">
                        <a href="single.html">
                            <img src="${contextPath}/resources/img/posts/masonry/4.jpg" alt="" class="img-responsive">
                            <img src="${contextPath}/resources/img/play-btn.png" alt="" class="video-mark">
                        </a>
                    </div>
                    <div class="post-excerpt row">
                        <h5 class="post-meta">
                ...
                <div class="post-wrapper row">
                    <div class="post-excerpt row">
                        ...
                        <footer class="row">
                            ...
                            <div class="response-count"><img src="${contextPath}/resources/img/comment-icon-white.png" alt="">5</div>
                        </footer>
                    </div>
                </div>
            </article>
    ...
    <div class="container">
        <div class="row top-footer">
            <div class="widget col-sm-3 widget-about">
                <div class="row m0"><a href="index.jsp"><img src="${contextPath}/resources/img/logo-black-green.png" alt=""></a></div>
            </div>
...
<script src="${contextPath}/resources/js/jquery-2.2.0.min.js"></script>
<script src="${contextPath}/resources/js/bootstrap.min.js"></script>
<script src="${contextPath}/resources/js/vendors/owl-carousel/owl.carousel.min.js"></script>
<script src="${contextPath}/resources/js/vendors/magnific-popup/jquery.magnific-popup.min.js"></script>
<script src="${contextPath}/resources/js/vendors/instafeed/instafeed.min.js"></script>
<script src="${contextPath}/resources/js/vendors/imagesLoaded/imagesloaded.pkgd.min.js"></script>
<script src="${contextPath}/resources/js/vendors/isotope/isotope.pkgd.min.js"></script>
